...
- Last task: cloned the canonical repo and replaced stale GitHub Pages SEO URLs with the custom domain.
- Validation: sitemap XML and 36 local refs passed; desktop and 390x844 mobile smoke passed with no overflow, broken loaded images, or sub-44px visible controls.
